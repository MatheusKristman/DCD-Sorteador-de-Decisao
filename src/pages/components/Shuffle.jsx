        ...
        <div ref={loadingRef} className='shuffle-overlay__loading-container'>
            ...
            <div className='shuffle-overlay__loading-container__box'>
                <div className='shuffle-overlay__loading-container__box__btn-overflow'>
                    <button
                        type='button'
                        className='shuffle-overlay__loading-container__box__btn-overflow__btn'
                        onClick={showResult}
                    >
                        Ver Decisão
                    </button>
    ...
    return (
        <div ref={resultRef} className='shuffle-overlay__result-container'>
            <div className='shuffle-overlay__result-container__result-displayer'>
                <h2 className='shuffle-overlay__result-container__result-displayer__result'>
                    {result}
                </h2>
            </div>
            ...
            <div className='shuffle-overlay__result-container__btn-box'>
                <button
                    onClick={reset}
                    type='button'
                    className='shuffle-overlay__result-container__btn-box__restart-btn'
                >
                    Reiniciar
                </button>
                <button
                    ...
                    type='button'
                    className='shuffle-overlay__result-container__btn-box__home-btn'
                >
                    Voltar para Início
                </button>
            </div>
...
const Shuffle = () => {
    const isShuffleLoading = useShufflerStore(
        (state) => state.isShuffleLoading
    );
